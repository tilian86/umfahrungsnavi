...
var VERSION = 'un-v27';
var GERUEST = [
  './', './index.html', './app.js?v=27', './stil.css?v=27',
  './verkehr.js?v=27', './pruefstand.js?v=27', './profil/umfahrung.brf',
  './vendor/maplibre/maplibre-gl.js?v=27', './vendor/maplibre/maplibre-gl.css?v=27',
