...
var VERSION = 'un-v17';
var GERUEST = [
  './', './index.html', './app.js?v=17', './stil.css?v=17',
  './verkehr.js?v=17', './pruefstand.js?v=17', './profil/umfahrung.brf',
  './vendor/maplibre/maplibre-gl.js?v=17', './vendor/maplibre/maplibre-gl.css?v=17',
