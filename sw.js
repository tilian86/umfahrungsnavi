...
var VERSION = 'un-v14';
var GERUEST = [
  './', './index.html', './app.js?v=14', './stil.css?v=14',
  './verkehr.js?v=14', './pruefstand.js?v=14', './profil/umfahrung.brf',
  './vendor/maplibre/maplibre-gl.js?v=14', './vendor/maplibre/maplibre-gl.css?v=14',
