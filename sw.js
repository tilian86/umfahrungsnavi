...
var VERSION = 'un-v19';
var GERUEST = [
  './', './index.html', './app.js?v=19', './stil.css?v=19',
  './verkehr.js?v=19', './pruefstand.js?v=19', './profil/umfahrung.brf',
  './vendor/maplibre/maplibre-gl.js?v=19', './vendor/maplibre/maplibre-gl.css?v=19',
