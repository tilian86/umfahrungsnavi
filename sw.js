...
var VERSION = 'un-v16';
var GERUEST = [
  './', './index.html', './app.js?v=16', './stil.css?v=16',
  './verkehr.js?v=16', './pruefstand.js?v=16', './profil/umfahrung.brf',
  './vendor/maplibre/maplibre-gl.js?v=16', './vendor/maplibre/maplibre-gl.css?v=16',
