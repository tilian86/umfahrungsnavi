...
var VERSION = 'un-v18';
var GERUEST = [
  './', './index.html', './app.js?v=18', './stil.css?v=18',
  './verkehr.js?v=18', './pruefstand.js?v=18', './profil/umfahrung.brf',
  './vendor/maplibre/maplibre-gl.js?v=18', './vendor/maplibre/maplibre-gl.css?v=18',
