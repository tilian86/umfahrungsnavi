...
var VERSION = 'un-v28';
var GERUEST = [
  './', './index.html', './app.js?v=28', './stil.css?v=28',
  './verkehr.js?v=28', './pruefstand.js?v=28', './profil/umfahrung.brf',
  './vendor/maplibre/maplibre-gl.js?v=28', './vendor/maplibre/maplibre-gl.css?v=28',
