...
var VERSION = 'un-v20';
var GERUEST = [
  './', './index.html', './app.js?v=20', './stil.css?v=20',
  './verkehr.js?v=20', './pruefstand.js?v=20', './profil/umfahrung.brf',
  './vendor/maplibre/maplibre-gl.js?v=20', './vendor/maplibre/maplibre-gl.css?v=20',
