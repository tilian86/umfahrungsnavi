...
var VERSION = 'un-v15';
var GERUEST = [
  './', './index.html', './app.js?v=15', './stil.css?v=15',
  './verkehr.js?v=15', './pruefstand.js?v=15', './profil/umfahrung.brf',
  './vendor/maplibre/maplibre-gl.js?v=15', './vendor/maplibre/maplibre-gl.css?v=15',
