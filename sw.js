...
var VERSION = 'un-v24';
var GERUEST = [
  './', './index.html', './app.js?v=24', './stil.css?v=24',
  './verkehr.js?v=24', './pruefstand.js?v=24', './profil/umfahrung.brf',
  './vendor/maplibre/maplibre-gl.js?v=24', './vendor/maplibre/maplibre-gl.css?v=24',
